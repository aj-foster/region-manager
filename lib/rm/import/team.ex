  ...
  def from_csv(data) do
    ...
    %__MODULE__{
      ...
      data: %__MODULE__.Data{
        ...
        lc1_email: String.downcase(lc1_email),
        lc1_email_alt: String.downcase(lc1_email_alt),
        lc1_name: lc1_name,
        lc1_phone: lc1_phone,
        lc1_phone_alt: lc1_phone_alt,
        lc1_ypp: lc1_ypp =~ "Satisfies",
        lc1_ypp_reason: if(lc1_ypp =~ "Does Not Satisfy", do: lc1_ypp_reason),
        lc2_email: String.downcase(lc2_email),
        lc2_email_alt: String.downcase(lc2_email_alt),
        lc2_name: lc2_name,
        lc2_phone: lc2_phone,
